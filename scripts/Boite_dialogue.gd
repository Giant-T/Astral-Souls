...
var dialogues = [
	'An 2069, la planète Terre subit un [shake rate=10 level=10]déficit sevère[/shake] en [color=red]hydrocarbures[/color]...',
	'Les scientifiques américains ont soulevé la possibité de voyager dans le temps à l\'aide de [rainbow freq=0.6 sat=20 val=8]Astral Souls[/rainbow] afin d\'exploité le pétrole qui n\'a pas été utilisé dans le passé.',
	'[rainbow freq=0.6 sat=20 val=8]Astral Souls[/rainbow] est le premier prototype de machine à voyager dans le temps, son nom référence les âmes et les étoiles, puisqu\'il permettra de faire voyager les âmes au dela des étoiles.',
	...
	'Mais le temps presse et le président des États-Unis doit remedier à la situation, les forces spéciales se sont emparés de [rainbow freq=0.6 sat=20 val=8]Astral Souls[/rainbow] durant la nuit, et vous, ...',
...
var images = [
	...
	'res://ressources/Images_intro/SpecialForces.png',
