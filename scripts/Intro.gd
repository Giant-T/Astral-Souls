...
var dialogues = [
	...
	'Les scientifiques américains ont soulevé la possibité de voyager dans le temps à l\'aide de [color=#1CC4D4][tornado radius=3 freq=2]Astral Souls[/tornado][/color] afin d\'exploiter le pétrole qui n\'a pas été utiliser dans le passé.',
	...
	'Mais le temps presse et le président des États-Unis doit remedier à la situation, les forces spéciales se sont emparées de [color=#1CC4D4][tornado radius=3 freq=2]Astral Souls[/tornado][/color] durant la nuit, et vous...',
